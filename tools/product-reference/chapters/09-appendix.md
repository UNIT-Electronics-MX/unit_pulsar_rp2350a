...
`1.0.0`; this label differs from the UNIT PULSAR RP2350 name and RP2350A
controller described in this reference.
...
### **9.3 Values Not Specified by the Technical Documentation** {.section-page}
...
- The board uses an RP2350A, but the schematic title block says
